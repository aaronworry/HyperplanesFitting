...
def main():
    ...
    # 设置路径 - 现在使用 results/2d/ 目录
    project_root = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
    results_dir = args.results_dir or os.path.join(project_root, 'results', '2d')
    output_dir = args.output_dir or os.path.join(project_root, 'results', '2d', 'figures')
